...
namespace GestionSalaraies
{
    ...
    {
        private static FrmUtilisateurs _instance;
        public static FrmUtilisateurs GetInstance()
        {
            if (_instance == null)
            {
                _instance = new FrmUtilisateurs();
            }
            return _instance;
        }
        ...
        private void ModifierUtilisateur()
        {
            ...
            if (IsValidChamps())
            {
                ...
                catch (Exception)
                {
                    ...
                    epUtilisateur.SetError(txtMotDePasse, "Le Prenom n'est pas valide");
                    epUtilisateur.SetError(txtNom, "Le Nom n'est pas valide");
                }
        ...
        private void FrmUtilisateurs_FormClosed(object sender, FormClosedEventArgs e)
        {
            _instance = null;
